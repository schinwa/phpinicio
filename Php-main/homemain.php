...
<html lang="en">
    ...
    <?php include ("menumain.php"); ?>
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Atividade de</div>
                <div class="masthead-heading text-uppercase">JS e PHP</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#services">Confira!</a>
            </div>
        </header>
         ...
         <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">E boa correção!</h3>
                </div>
